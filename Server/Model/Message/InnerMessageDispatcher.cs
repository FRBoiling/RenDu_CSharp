...
namespace Model.Message
{
    public class InnerMessageDispatcher : IMessageDispatcher
    {
        public void Dispatch(Session session, ushort opcode, object message)
        {
            ...
            //        {
            //            BaseEntity entity = (BaseEntity)Server.EventSystem.Get(iActorRequest.ActorId);
            //            if (entity == null)
            //            {
            //                Log.Warn($"not found actor: {message}");
            ...
            //        {
            //            BaseEntity entity = (BaseEntity)Server.EventSystem.Get(iactorMessage.ActorId);
            //            if (entity == null)
            //            {
