...
namespace Model.Network.TCP
{
    ...
    public sealed class TcpChannel : AChannel
    {
        ...
        public TcpChannel(Socket socket, TcpService service) : base(service, ChannelType.Accept)
        {
            int packetSize = service.PacketSizeLength;
            this.packetSizeCache = new byte[packetSize];
            this.memoryStream = service.MemoryStreamManager.GetStream("message", ushort.MaxValue);
        ...
        {
            return (TcpService)this.Service;
        }
        ...
        private void OnComplete(object sender, SocketAsyncEventArgs e)
        {
            switch (e.LastOperation)
            {
                case SocketAsyncOperation.Connect:
                    SingletonSynchronizationContext.Instance.Post(this.OnConnectComplete, e);
                    break;
                case SocketAsyncOperation.Receive:
                    SingletonSynchronizationContext.Instance.Post(this.OnRecvComplete, e);
                    break;
                case SocketAsyncOperation.Send:
                    SingletonSynchronizationContext.Instance.Post(this.OnSendComplete, e);
                    break;
                case SocketAsyncOperation.Disconnect:
                    SingletonSynchronizationContext.Instance.Post(this.OnDisconnectComplete, e);
                    break;
                default:
