...
namespace Model.Base
{
    ...
    public sealed class EventSystem
    {
        ...
        public AComponent Get(long instanceId)
        {
        ...
        public void Deserialize(AComponent component)
        {
        ...
        public void Awake<P1, P2>(AComponent component, P1 p1, P2 p2)
        {
            List<IAwakeSystem> iAwakeSystems = this.awakeSystems[component.GetType()];
            if (iAwakeSystems == null)
            {
        ...
        public void Awake<P1, P2, P3>(AComponent component, P1 p1, P2 p2, P3 p3)
        {
            List<IAwakeSystem> iAwakeSystems = this.awakeSystems[component.GetType()];
            if (iAwakeSystems == null)
            {
        ...
        public void Change(AComponent component)
        {
