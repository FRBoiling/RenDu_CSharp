...
namespace Model.Message
{
    public sealed class Session : BaseEntity
    {
        ...
        public RDTask<IResponse> Call(IRequest request)
        {
            int rpcId = ++RpcId;
            var tcs = new RDTaskCompletionSource<IResponse>();
        ...
        public RDTask<IResponse> Call(IRequest request, CancellationToken cancellationToken)
        {
            int rpcId = ++RpcId;
            var tcs = new RDTaskCompletionSource<IResponse>();
